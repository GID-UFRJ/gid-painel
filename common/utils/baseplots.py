...
class BasePlots:
    ...
    def _entidades_por_ano(
        ...
        **kwargs,
        ...
        """
        Função genérica para gerar gráficos por ano usando MAPEAMENTOS.
        Aceita filtros de qualquer tipo (str, int, etc.) e ignora valores None ou "total" (apenas strings).
        """
        ...
        for chave_filtro, valor in filtros_selecionados.items():
            ...
            if isinstance(valor, str) and valor.lower() == "total":
                continue  # ignora "total" apenas se for string
        ...
        if campo_grupo:
            ...
            # Pivota para garantir todos os anos
