...
DICIONARIO_CURADO = {
    # Nomes oficiais traduzidos para o português
    "INSTITUTO DE ENGENHARIA NUCLEAR": "IEN",
    "OBSERVATÓRIO DO VALONGO": "OBS. VALONGO",
    "CONSELHO NACIONAL DE DESENVOLVIMENTO CIENTÍFICO E TECNOLÓGICO": "CNPQ",
    "INSTITUTO MILITAR DE ENGENHARIA": "IME",
    "UNIVERSIDADE ESTÁCIO DE SÁ": "ESTÁCIO", # ou apenas "ESTÁCIO (BRASIL)"
    ...
    # --- É RECOMENDADO MANTER AS CHAVES EM INGLÊS TAMBÉM ---
    ...
    # Instituições originais em português
