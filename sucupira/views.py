...
# O Dispatcher e os Dicionários de Mapeamento
...
def ppg_detalhe(request, programa_id):
    ...
    cursos = Curso.objects.filter(programa_id=programa_id).select_related("grau_curso").order_by("grau_curso__nm_grau_curso")
    
    # Injeção do programa_id nos filtros iniciais
    filtros_iniciais = {'programa_id': programa_id}
